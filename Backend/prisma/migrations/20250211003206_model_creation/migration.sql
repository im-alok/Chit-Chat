...
-- CreateIndex
CREATE UNIQUE INDEX "Chat_latestMessage_key" ON "Chat"("latestMessage");
...
-- AddForeignKey
ALTER TABLE "Chat" ADD CONSTRAINT "Chat_latestMessage_fkey" FOREIGN KEY ("latestMessage") REFERENCES "Message"("id") ON DELETE SET NULL ON UPDATE CASCADE;
